...
class ExampleDecorationImage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return <Widget>[
      '3 Type of decorationimage'.xH1Text(color: Colors.black).xap(value: 20.0),
      <Widget>[
      ...
      'https://image.freepik.com/free-vector/abstract-technology-particle-background_52683-25766.jpg'
          .decorationINToCover()
          .xContainer(
              child: 'Image Show Text'.xTextColorWhite().toCenter(),
              blurRadius: 50.0,
              spreadRadius: 1.0,
        ...
        appBar: 'Decorationimage'.xTextColorBlack().xAppBar(
